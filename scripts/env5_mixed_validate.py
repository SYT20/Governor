...
SEED = 2027   # PREREGISTERED validation seed, fixed before this run
...
def main() -> int:
    t = ProbeTask(cfg=make_config(SIGMA, 1.0, 0.05), n_samples=N_STATES, seed=SEED)
    ...
    for i in range(N_STATES):
        ...
        p = ib.b._norm(logL); rng = np.random.default_rng(70000 + i); d = []
    ...
    Path("results/env5_mixed_validate.json").write_text(json.dumps(res, indent=2))
